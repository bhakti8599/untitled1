...
class QuestionPaperRepo {
  ...
  Future<HttpResponse> getQuestionPaper(QuestionPaperRequestModel model) async {
    ...
    await httpClient!
        .get(
      BaseUrl.baseUrl + endPoints.Student().questionpapers+model.getString(),
    )
        .then((responce) async {
      print(responce);
      ...
      if (responce.statusCode == 200) {
        ...
        httpResponse.data = QuestionPaper.fromJson(responce.data);
