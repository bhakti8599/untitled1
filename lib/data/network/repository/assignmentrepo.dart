...
class AssignmentRepo {
  ...
  Future<HttpResponse> getAssignments(AssignmentRequestModel model) async {
    ...
    await httpClient!
        .get(
      BaseUrl.baseUrl + endPoints.Student().assignments+model.getString(),
    )
        .then((responce) async {
      print(responce);
      ...
      if (responce.statusCode == 200) {
        ...
        httpResponse.data = AssignmentResponse.fromJson(responce.data);
