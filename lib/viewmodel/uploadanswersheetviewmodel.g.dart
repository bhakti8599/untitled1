...
part of 'uploadanswersheetviewmodel.dart';
...
mixin _$UploadAnswerSheetViewModel on _UploadAnswerSheetViewModel, Store {
  final _$titleAtom = Atom(name: '_UploadAnswerSheetViewModel.title');
  ...
  final _$isLoadingAtom = Atom(name: '_UploadAnswerSheetViewModel.isLoading');
  ...
  final _$assignmentResponseAtom =
      Atom(name: '_UploadAnswerSheetViewModel.assignmentResponse');
  ...
  final _$descAtom = Atom(name: '_UploadAnswerSheetViewModel.desc');
  ...
  final _$getAssignmentAsyncAction =
      AsyncAction('_UploadAnswerSheetViewModel.getAssignment');
