...
part of 'assignmentviewmodel.dart';
...
mixin _$AssignmentViewModel on _AssignmentViewModel, Store {
  final _$titleAtom = Atom(name: '_AssignmentViewModel.title');
  ...
  final _$isLoadingAtom = Atom(name: '_AssignmentViewModel.isLoading');
  ...
  final _$assignmentResponseAtom =
      Atom(name: '_AssignmentViewModel.assignmentResponse');
  ...
  final _$descAtom = Atom(name: '_AssignmentViewModel.desc');
  ...
  final _$getAssignmentAsyncAction =
      AsyncAction('_AssignmentViewModel.getAssignment');
